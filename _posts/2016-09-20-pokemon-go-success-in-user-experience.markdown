...
<p>As I was the only researcher in this experiment and the study itself had a limited time span I focused only on the momentary UX which from my personal experience is the most insightful, most revealing and of course the easiest to quantitatively test. Momentary UX explains how many positive emotions (or even negative) are evoked during the interaction with the system.
What I discovered is that playing both of these games leaves people with significantly positive feelings afterwards or in other words makes them happier. However, the biggest finding of the study is that the levels of evoked positive emotions afterwards were much more expressed in the AR version than they were in the VR. This can be clearly seen on the following illustration:</p>
...
<p>Therefore, even though the game mechanics of Pokemon GO and my own developed game are inherently different It can still be argued that the success of the Pokemon might lie in its superior user experience which Augmented Reality elicits.</p>
